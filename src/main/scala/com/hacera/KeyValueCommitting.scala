...
import com.digitalasset.daml.lf.value.Value.{AbsoluteContractId, ContractId, ContractInst, NodeId, VersionedValue}
...
object KeyValueCommitting {
  ...
  private def processTransactionSubmission(
    ...
    val letCheckResult = true // for now, don't check this
